...
// Here is one proble with this code that is this not update the password 
// becouse we can not select the password from are database i don't know why 
// but try with new user 
